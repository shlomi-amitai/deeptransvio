...
def plot_sequence(imu_data, poses, image_files, ahrs_data, start_idx, num_samples, data_ranges):
    ...
    ax_end_img.axis('off')
    ax_end_img.set_title(f"End Image at t={extract_timestamp(image_files[start_idx + num_samples - 1]):.6f}s", fontsize=10)
...
fig, axes, start_img_plot, end_img_plot = plot_sequence(imu_data, poses, image_files, ahrs_data, start_idx, num_samples, data_ranges)
...
class Index:
    ...
    def next(self, event):
        ...
        update_plot(fig, axes, start_img_plot, end_img_plot, imu_data, poses, image_files, ahrs_data, self.start_idx, self.num_samples, self.data_ranges)
